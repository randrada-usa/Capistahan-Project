...
class AssetManager:
    ...
    def load_all(self):
        ...
        # --- GLOW SFX ---
        self._load_audio('blue', os.path.join("audio", "BLUE.mp3"))
        self._load_audio('gold', os.path.join("audio", "GOLD.mp3"))
        self._load_audio('red', os.path.join("audio", "RED.mp3"))
        self._load_audio('uber_rare', os.path.join("audio", "UBER-RARE.mp3"))
        ...
        menu_music = os.path.join(self.base_path, "audio", "MENU(FINAL).mp3")
    ...
    def _load_audio(self, sound_name, relative_path):
        ...
        try:
            ...
            # Also store in assets dict so FallingItem can access it
            self.assets[sound_name] = self.sounds[sound_name]
        except:
            self.sounds[sound_name] = None
            self.assets[sound_name] = None
